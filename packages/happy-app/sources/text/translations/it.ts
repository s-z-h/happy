...
export const it: TranslationStructure = {
    ...
    settingsAppearance: {
        ...
        sessionGrouping: 'Raggruppamento sessioni',
        sessionGroupingDescription: 'Scegli come organizzare le sessioni inattive',
        sessionGroupingDate: 'Per data',
        sessionGroupingDevice: 'Per dispositivo',
