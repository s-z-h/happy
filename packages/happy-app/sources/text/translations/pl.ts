...
export const pl: TranslationStructure = {
    ...
    settingsAppearance: {
        ...
        sessionGrouping: 'Grupowanie sesji',
        sessionGroupingDescription: 'Wybierz sposób organizacji nieaktywnych sesji',
        sessionGroupingDate: 'Wg daty',
        sessionGroupingDevice: 'Wg urządzenia',
