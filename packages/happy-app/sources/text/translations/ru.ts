...
export const ru: TranslationStructure = {
    ...
    settingsAppearance: {
        ...
        sessionGrouping: 'Группировка сессий',
        sessionGroupingDescription: 'Выберите способ организации неактивных сессий',
        sessionGroupingDate: 'По дате',
        sessionGroupingDevice: 'По устройству',
